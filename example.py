...
print('\ta mean of '+str(mmInfo['avg'])+' damage.')
...
print('\tyou will get a mean result of '+str(atInfo['avg'])+'.')
...
print('\tyou have a '+str(rollWin(atInfo,)*100)+'% chance of hitting an AC of '+str(target)+'.')
